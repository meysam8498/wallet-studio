...
ورود با ایمیل و گذرواژه — بدون SMTP، بدون تأیید ایمیل، بدون هیچ سرویس بیرونی.

▌راه‌اندازی سریع

1) هیچ راه‌اندازی‌ای لازم نیست — فقط اجرا کنید:
...
• VITE_CONVEX_URL در زمان اجرا تزریق می‌شود؛ همهٔ دستگاه‌هایی
  که همین آدرس را داشته باشند، با یک حساب، دادهٔ یکسان و زنده می‌بینند.
• ورود: ایمیل + گذرواژه (هش Scrypt در بک‌اند) یا حالت مهمان برای آزمایش سریع.
• نسخه‌های تگ‌شده: meysam8498/daftaram:2.4.0
