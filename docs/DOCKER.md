...
پیش‌نیاز داده‌ای: آدرس بک‌اند باید **در زمان ساخت** در متغیر
`VITE_CONVEX_URL` ثبت شود — این مقدار در خروجی جاوااسکریپت جاسازی می‌شود و
بعد از build قابل تغییر نیست (برای تغییر، تصویر را دوباره بسازید).
...
| کد ورود ایمیل نمی‌آید | SMTP پیکربندی نشده | متغیرهای `SMTP_*` را در داشبورد Convex تنظیم کنید |
