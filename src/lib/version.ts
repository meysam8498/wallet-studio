...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    version: "2.6.0",
    date: "۱۴۰۵/۰۶/۲۹",
    title: "دستیار هوشمند، شنود پیامک بانکی و بازیابی پشتیبان",
    changes: [
      { type: "added", text: "دستیار هوشمند ثبت سریع: جملهٔ فارسی بنویسید یا بگویید (مثل «۲۰۰ تومن دادم به اسنپ») و پیش‌نویس تراکنش با نوع، مبلغ و دسته پیشنهاد می‌شود — ذخیره فقط با تأیید شما" },
      { type: "added", text: "زنجیرهٔ جایگزینی ارائه‌دهنده‌های هوش مصنوعی (OpenRouter → Groq → OpenCode → Google): اگر یکی در دسترس نبود بعدی تشخیص می‌دهد؛ با هیچ کلیدی هم تجزیه‌گر قاعده‌محور داخلی پاسخ می‌گوید" },
      { type: "added", text: "کلیدهای هوش مصنوعی فقط در متغیرهای محیطیِ سرور ذخیره می‌شوند و هرگز در کد یا بسته‌ها نمی‌آیند" },
      { type: "added", text: "شنود پیامک بانکی در اندروید: برداشت و واریز از پیامک بانک‌ها تشخیص داده می‌شود (ریال و تومان)، پیامک هنگام باز بودن برنامه به‌صورت پیش‌نویس تأیید باز می‌شود و هنگام بسته‌بودن اعلان محلی می‌آید — بدون سرویس دائمی و با کمترین مصرف باتری" },
      { type: "added", text: "بازیابی پشتیبان: فایل JSON خروجی کنار دکمهٔ «پشتیبان JSON» در دفتر فعال ادغام می‌شود — هیچ داده‌ای حذف نمی‌شود و سندهای تکراری رد می‌گردند" },
      { type: "changed", text: "چیدمان کارت‌های داشبورد اکنون روی سرور ذخیره می‌شود: ترتیب و پنهان‌سازی روی ویندوز، اندروید و وبِ همان حساب یکسان دیده می‌شود (رفع مشکل ذخیره‌نشدن در ویندوز)" },
      { type: "added", text: "کد دعوت خانوار همیشه در مدیر دفتر برای مالک نمایان است — ساخت، کپی و به‌روزرسانی با یک کلیک" },
      { type: "added", text: "پشتیبانی macOS (Apple Silicon و Intel) و لینوکس (AppImage و deb) با گردش‌کار انتشار خودکار؛ بستهٔ iOS بدون امضا برای نصب با حساب شخصی" },
      { type: "changed", text: "پاک‌سازی کامل تاریخچهٔ گیت از نشانه‌های ابزار ساخت (بدون بازنویسی محتوا)" },
    ],
  },
  {
    version: "2.4.0",
    date: "۱۴۰۵/۰۶/۲۳",
    title: "تختهٔ کارت‌های شخصی و مدیریت دفترها",
    changes: [
      { type: "added", text: "چیدمان شخصی داشبورد: کارت‌ها (دسته‌بندی‌ها، نمای سالانه، روند، انتقال‌ها، بودجه، تراکنش‌ها) با منوی «چیدمان» جابه‌جا، پنهان یا بازنشانی می‌شوند — ذخیره روی همان دستگاه" },
      { type: "changed", text: "چیدمان masonry دوستونه: کارت‌ها دیگر مثل قطار زیر هم نمی‌آیند و نیمی از صفحه خالی نمی‌ماند؛ هر کارت در ستون خودش تا ارتفاع کامل می‌نشیند" },
      { type: "added", text: "نشان «دفتر فعال» کنار عنوان ماه: نام دفتر شخصی یا خانوار را نشان می‌دهد و با کلیک، مدیر دفترها باز می‌شود" },
      { type: "fixed", text: "رفع بیرون‌زدگی جدول تراکنش‌ها و کارت‌های داده‌دار در موبایل — تأیید صفرِ اسکرول افقی با پروب خودکار در ۳۶۰px و ۱۳۶۶px" },
      { type: "added", text: "پرداخت گرافیکی: عمق ملایم کارت‌ها در هاور، اسکرول‌بار باریک هم‌رنگ تم، محو لبهٔ ریل حساب‌ها و انیمیشن ورود پلکانی کارت‌ها (با احترام به reduced-motion)" },
    ],
  },
  {
    version: "2.3.0",
